...
def load_cifar(path = "cifar-10-batches-py"):
	...
	for i in range(1, 6):
		cifar_out = pickle.load(open(os.path.join(path, "data_batch_{0}".format(i))),encoding = 'iso-8859-1')
	...
	cifar_out = pickle.load(open(os.path.join(path, "test_batch")),encoding = 'iso-8859-1')
